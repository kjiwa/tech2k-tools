...
def sample_excel(tmp_path):
    ...
    ws.append(headers)
    ws.append(["WPW10321304", "FILTER", "", "", "", "", "", 10.0, "Flat", 18.0, "Flat", "Yes", "WPL", "Marcone", "Active"])
    ws.append(["240323002", "BIN", "", "", "", "", "", None, "Flat", None, "Flat", "Yes", "FRG", "Other", "Active"])
    ws.append(["NOTFOUND99", "UNKNOWN", "", "", "", "", "", None, "Flat", None, "Flat", "Yes", "", "", "Active"])
